...
#保留base包里面的所有类不被混淆
-keep class com.alex.code.foundation.base.** {*;}
...
-keep class com.alex.code.foundation.bean.** {*;}
...
-keep public class [com.alex.code.foundation].R$*{
public static final int *;
}
-keepclassmembers enum * {
    public static **[] values();
...
-keep class com.alex.code.foundation.wxapi.**{
   *;
}
# ----- Wechat pay End -----