...
public class SnapUpCountDownTimerView extends LinearLayout {
    ...
    public SnapUpCountDownTimerView(Context context, AttributeSet attrs) {
        ...
        tv_hour_decade.setTextSize(mTextSize);
        tv_hour_unit.setTextSize(mTextSize);
        tv_min_decade.setTextSize(mTextSize);
        tv_min_unit.setTextSize(mTextSize);
        tv_sec_decade.setTextSize(mTextSize);
        tv_sec_unit.setTextSize(mTextSize);
        ((TextView)view.findViewById(R.id.colon_minute)).setTextSize(mTextSize);
        ((TextView)view.findViewById(R.id.colon_hour)).setTextSize(mTextSize);
    }
