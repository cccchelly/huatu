...
public class CustomPopupWindow extends PopupWindow {
    ...
    private void initLayout() {
        ...
        setWidth(isWrapWidth ? LayoutParams.WRAP_CONTENT : LayoutParams.MATCH_PARENT);
        setHeight(isWrapHeight ? LayoutParams.WRAP_CONTENT : LayoutParams.MATCH_PARENT);
    ...
    public static final class Builder {
        ...
        public Builder isWrap(boolean isWrapWidth , boolean isWrapHeight) {
            this.isWrapWidth = isWrapWidth;
